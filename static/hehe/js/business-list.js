...
new Vue({
	...
	methods:{
		getNewsBypg(){
			axios.get(`https://www.hehefilm.com/resources/project?pg=${this.nowNumber}&num=6` + '&lang=' + (getCookie('lang') == 'en' ? 'en' : 'zh'))
			.then(resp => {
...
//				this.allPage = 5;
		...
		getMove(){
			axios.get(`https://www.hehefilm.com/resources/movie_recommend` + '?lang=' + (getCookie('lang') == 'en' ? 'en' : 'zh'))
			.then(resp => {
